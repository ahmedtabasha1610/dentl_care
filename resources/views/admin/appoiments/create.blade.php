...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"> Create Appoiments</h4>
<form action="{{route('appoiments.store')}}" method="POST" enctype="multipart/form-data">
            @csrf
            @if ($errors->any())
            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="mb-0">Create Appoiment</h5>
                        <small class="text-muted float-end">Create Appoiment</small>
                    </div>
                    <div class="card-body">
                        <form>
                            <div class="row mb-3">
