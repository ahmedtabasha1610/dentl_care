              ...
              <span class="app-brand-logo demo">
                ...
                >
                  ...
                  <g id="g-app-brand" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="app-brand-text demo menu-text fw-bolder ms-2">One Health</span>
                </a>
                ...
                <li class="menu-item">
                  ...
                  <li class="menu-item">
                    <a href="{{ route('prices.index') }}" class="menu-link">
                      <i class="menu-icon tf-icons bx bx-collection"></i>
                      <div data-i18n="Basic">Prices</div>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a href="{{ route('appoiments.index') }}" class="menu-link">
                      <i class="menu-icon tf-icons bx bx-collection"></i>
                      <div data-i18n="Basic">Appoiments</div>
                    </a>
                  </li>
            </ul>
        </aside>
