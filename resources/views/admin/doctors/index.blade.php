...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card-header">
            <h2 class="fw-bold py-1 mb-1"> Doctors</h2>
        </div>
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('doctors.create') }}" class="btn btn-primary float-end">Create</a>
                        ...
                        <tbody>
                            @foreach ($data as $doctor)
                                <tr>
                                    ...
                                    <td>
                                        <ul class="d-flex align-items-center">
                                            <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
                                                class=" pull-up" title=""
                                                data-bs-original-title="{{ $doctor->name }}">
                                                <img src="{{ Storage::url('doctors/' . $doctor->image) }}" alt=""
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a href="{{route('doctors.edit',$doctor->id)}}" class="btn btn-info"><i class='bx bx-edit-alt'></i></a>
