...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"> Create Doctors</h4>
            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="mb-0">Create Doctors</h5>
                        <small class="text-muted float-end">Create Doctors</small>
                    </div>
                    <div class="card-body">
                        <form>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                <label for="defaultSelect" class="col-sm-2 col-form-label">Choose Category</label>
                                <div class="col-sm-10">
